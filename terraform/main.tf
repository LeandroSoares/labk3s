...
# Módulo de tracing com Grafana Tempo
module "tempo" {
...
module "grafana_agent" {
  ...
  # Removido o count para sempre ativar o Grafana Agent
  ...
  tempo_endpoint           = var.tempo_enabled ? "tempo:4317" : ""  # Endpoint do serviço Tempo dentro do cluster
}
